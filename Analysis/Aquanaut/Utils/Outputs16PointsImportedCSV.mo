...
model Outputs16PointsImportedCSV
  
  Modelica.Blocks.Sources.CombiTimeTable dataTable(tableOnFile = true, tableName = "OutputData", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://Aquanaut/Resources/data.csv"), columns = {2, 3, 4, 5}, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint)  annotation(
  ...
  equation
    ...
    annotation(
    experiment(StartTime = 0, StopTime = 4096, Tolerance = 1e-06, Interval = 0.01),
