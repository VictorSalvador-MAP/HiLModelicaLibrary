...
model HeadingSensor
  "Absolute vessel heading calculated from the body reference frame"

  Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a
    "Reference frame whose heading is measured"
    annotation (
      Placement(
        transformation(
          origin={-90,0},
...
annotation (
  ...
  Icon(
    ...
    graphics={
      ...
      Polygon(
        points={{25,25},{14,21},{21,14},{25,25}},
        lineColor={0,0,127},
        fillColor={0,0,127},
        fillPattern=FillPattern.Solid),
  ...
  Diagram(
    ...
    graphics={
      ...
      Text(
        extent={{-65,35},{65,15}},
        textString="Heading Sensor",
        textColor={0,0,127}),

      Text(
        extent={{-65,5},{65,-15}},
        textString="Body frame -> World",
        textColor={0,0,0}),

      Text(
        extent={{-65,-15},{65,-35}},
        textString="atan2(y,x)",
        textColor={0,0,0}),
