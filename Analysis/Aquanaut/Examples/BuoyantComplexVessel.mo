...
model BuoyantComplexVessel
  extends Modelica.Icons.Example;

  ShipParts.Hull hull(initPos = true, sphereViewer = false, shapeModel = "modelica://Aquanaut/Resources/STL/sphereRef1cm.stl", Ixx = 47000, Iyy = 47000, Izz = 47000)  annotation(
  ...
  HydroForces.Buoyancy buoyancy(shapePath = "modelica://Aquanaut/Resources/STL/sphereRef1cm.stl", wavePath = "modelica://Aquanaut/Resources/STL/flat_wave_", output_folder = "modelica://Aquanaut/Resources/STL/", useComplexShape = true, time_step = 1, outputEnable = false, dist_keel_cg = 5)  annotation(
...
equation
  ...
  connect(buoyancy.frame_a, hull.frame_a) annotation(
    Line(points = {{36, 22}, {16, 22}, {16, -18}, {36, -18}}, color = {95, 95, 95}));
  annotation(
